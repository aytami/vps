...
echo "<pre>Setup by Hzro Store vengeance WA 085156022091</pre>" > /home/vps/public_html/index.php
...
echo ""
echo "----------------------------------------"
echo "        SCRIPT BY HZRO STORE      "
echo "             WA: 085156022091       "
echo "----------------------------------------"
